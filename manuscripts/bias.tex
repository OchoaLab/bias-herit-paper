...
% WRONG :(
% Moreover, the rowspaces of
% $\left( \mathbf{C} \kinMat \mathbf{C} \right)_r$
% and
% $\mathbf{C} \kinMat_r \mathbf{C}$
% are the same, since (1) centering before or after the low-dimensional approximation both result in $\mathbf{1}_n$ being in the nullspace of $\kinMatStdLim_r$, and (2) ...
